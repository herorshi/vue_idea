...
<!-- end int-header -->
<main >
  <section class="host-price">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 price-box">      
            <h2 class="wow fadeInUp" data-wow-delay="0.05s">Hosting Plan</h2><br/>
          ...
          <div class="plan">
            <div class="plan-inner">
              <div class="entry-title">
                <h3>PLAN A</h3>
                <div class="price">1,000<span>บาท/ต่อปี</span></div>
              </div>
              <div class="entry-content">
                <ul>
          <li><strong>ไม่จำกัด</strong> sub domain</li>
          <li><strong>ไม่จำกัด</strong> ฐานข้อมูล</li>
          <li><strong>ไม่จำกัด</strong> FTP</li>
          <li>พื้นที่ใช้งาน 1 GB</li>
  ...
  <div class="plan basic">
    <div class="plan-inner">
     <!--<div class="hot">hot</div>-->
      <div class="entry-title">
        <h3>PLAN B</h3>
        <div class="price">2,000 <span>บาท/ต่อปี</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
            ...
            <li><strong>ไม่จำกัด</strong> ฐานข้อมูล</li>
            <li><strong>ไม่จำกัด</strong> FTP</li>
            <li>พื้นที่ใช้งาน 2 GB</li>
            <li>Bandwidth 20 GB</li>
            <li>1 domain</li>
        </ul>
      </div>
      <div class="btn">
  ...
  <div class="plan standard">
    <div class="plan-inner">
      <div class="entry-title">
        <h3>PLAN C</h3>
        <div class="price">3,000 <span>บาท/ต่อปี</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
  ...
  <div class="plan ultimite">
    <div class="plan-inner">
      <div class="entry-title">
        <h3>PLAN D</h3>
        <div class="price">4,000 <span>บาท/ต่อปี</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
