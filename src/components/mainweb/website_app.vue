...
<!-- end int-header -->
<main>
  <section class="title-box" style="margin-top:100px;">
    <div class="header">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <h2 class="wow fadeInUp" data-wow-delay="0.5s">Website & App</h2>
            <h5 class="wow fadeInUp" data-wow-delay="0.10s">รับทำเว็บไซต์ ออกแบบเว็บไซต์ พัฒนาเว็บแอพพลิเคชัน</h5>
    ...
    <section class="contact-form" style="background-image: linear-gradient(to top, #75DDD9,white );">
            <div class="container">
                    <div class="row">
                    <div class="col-xs-12">
                        <div class="title-box">
                        
                            <h3 class="wow fadeInUp" data-wow-delay="0.10s">ติดต่อขอใบเสนอราคา</h3>
