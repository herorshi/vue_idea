...
<!-- end navbar -->
<section class="int-header hero9">
  <div class="table">
    <div class="inner">
      <div class="container">
        <h3>Domain</h3>
  ...
  <section class="domain-price">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 price-box">      
            <h2 class="wow fadeInUp" data-wow-delay="0.05s">Domain Plan</h2><br/>
    ...
    <div class="container">
      <div class="row">
        ...
        <table>
                <tr id="mainth">
                  <th colspan="3">ราคาแพ็กเกจ Domain Name Pricing</th>
                </tr>
                <tr id="subth">
                  <td>Domain Name</td>
                  <td>Baht/1ปี</td>
                ...
                <tr>
                  <td>.com</td>
                  <td>450</td>                        
                  <td id="remark" rowspan="11" class="align-center">ชำระค่าบริการเป็นรายปี<br><span style="font-size: 20px;">(ยังไม่รวม VAT 7%)</span></td>
                </tr>
                <tr>
                  <td>.net</td>
                  <td>450</td>                         
