...
<!-- end navbar -->
<section class="int-header hero10">
  <div class="table">
    <div class="inner">
      <div class="container">
        <h3>Faceboo Ads.</h3>
...
<!-- end int-header -->
<main >
  <section class="facebook-price">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 price-box">      
            <h2 class="wow fadeInUp" data-wow-delay="0.05s">Facdbook Ads. Plan</h2><br/>
          ...
          <div class="plan">
            <div class="plan-inner">
              <div class="entry-title">
                <h3>3 เดือน</h3>
                <div class="price">7,500<span> บาท/เดือน</span></div>
              </div>
              <div class="entry-content">
                <ul>
          <li><strong>ไม่จำกัด</strong> คีย์เวิร์ด</li>
          <li><strong>ไม่จำกัด</strong> โฆษณา</li>
          <li>มีรายงาน</li>
          <li>Pays per Click (Min. Budget)<br/>5,000 ต่อเดือน</li>
        </ul>
      </div>
      <div class="btn">
  ...
  <div class="plan basic">
    <div class="plan-inner">
     <!--<div class="hot">hot</div>-->
      <div class="entry-title">
        <h3>6 เดือน</h3>
        <div class="price">13,500<span>บาท/เดือน</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
  ...
  <div class="plan standard">
    <div class="plan-inner">
      <div class="entry-title">
        <h3>12 เดือน</h3>
        <div class="price">24,000<span>บาท/เดือน</span>
        </div>
      </div>
      <div class="entry-content">
        <ul>
